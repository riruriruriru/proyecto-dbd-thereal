...
<div class="section-content">
        <h1 class="section-header">Modificar <span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s"> Evento</span></h1>
        <h3></h3>
</div>
<div class="contact-section">
<div class="container">
  
<form  method="POST" action="{{route ('evento.updateFinal') }}">
                        {{ csrf_field() }}
<fieldset>
...
<div class="form-group">
  ...
  <input id="nombre" name="nombre" placeholder="Nombre" class="form-control" required="" type="text"  value="{{$evento->nombre}}">
</div>

<div class="form-group">
  <label for="textinput">Cantidad Voluntarios Restantes</label>  
  <input id="voluntarios_restantes" name="voluntarios_restantes" placeholder="Nombre" class="form-control" required="" type="text"  value="{{$evento->cantidad_voluntarios}}">
</div>
<!-- Select Basic -->
<div class="form-group">
  <input id="id_evento" name="id_evento" placeholder="Nombre" class="form-control" required="" type="hidden"  value="{{$evento->id_evento}}" >
</div>
...
<div class="form-group">
  ...
  <input id="lugar_evento" name="lugar_evento"  placeholder="Lugar" class="form-control" required="" readonly="readonly" value= '{{$evento->direccion}}' type="text"  >
...
<div class="form-group">
  ...
  <input id="fecha_inicio_evento" name="fecha_inicio_evento" placeholder="" class="form-control" required="" type="date" value="{{$evento->fecha_inicio_evento}}"> 
</div>
<div class="form-group">
  <label for="monto_objetivo">Fecha Termino</label>  
 
  <input id="fecha_termino_evento" name="fecha_termino_evento" placeholder="" class="form-control" required="" type="date" value="{{$evento->fecha_termino_evento}}"> 
</div>
<!-- Textarea -->
...
<div class="form-group">
  ...
  <input id="cantidad_participantes" min="1" name="cantidad_participantes" placeholder="Cantidad" class="form-control" type="number" min="1">
