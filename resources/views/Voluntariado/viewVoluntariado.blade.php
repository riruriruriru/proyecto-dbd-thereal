...
<div class="container">
 ...
 <div class="section-content">
        <h1 class="section-header">Agregar <span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s"> Voluntariado</span></h1>
        <h3></h3>
      </div>
<div class="contact-section">
<div class="container">
<form  method="POST" action="{{ route('voluntariado.store') }}">
                        {{ csrf_field() }}
<fieldset>
...
<!-- Text input-->
<div class="form-group">
  <input id="id_medidas_voluntariado" name="id_medidas_voluntariado"  placeholder="" class="form-control" required="" value="{{$id_medidas_voluntariado}}" type="hidden">
...
<div class="col-md-6">
<div class="form-group">
  <label  for="fecha_inicio_evento">Fecha Inicio Voluntariado</label> 
  <input id="fecha_inicio_evento" name="fecha_inicio_voluntariado"  placeholder="Fecha Inicio Evento" class="form-control" required="" type="date">

</div>

<!-- Text input-->
<div class="form-group">
  <label  for="fecha_termino_evento">Fecha Termino Voluntariado</label> 
  <input id="fecha_termino_evento" name="fecha_termino_voluntariado"  placeholder="Fecha Termino Evento" class="form-control" required="" type="date">
