...
<div class="section-content">
        <h1 class="section-header">Agregar Trabajo <span class="content-header wow fadeIn " data-wow-delay="0.2s" data-wow-duration="2s"> Voluntariado</span></h1>
        <h3></h3>
</div>
<div class="contact-section">
<div class="container">
  
<form  method="POST" action="{{route ('voluntariado.update') }}">
                        {{ csrf_field() }}
<fieldset>
...
<div class="form-group">
  ...
  <input id="nombre" name="nombre_acopio" placeholder="Nombre" class="form-control" required="" type="text" readonly="readonly" value="{{$voluntariado->nombre}}">
</div>
